export default function WhoAreWe() {
   return (
      <div className="flex w-screen flex-col gap-14 bg-primary py-10 text-neutral">
         ...
         <div className="m-auto flex w-3/4 justify-evenly gap-10">
            <div className="gap-5/12 flex w-3/12 flex-col items-center">
               <h4 className="font-outfit text-6xl font-bold">+4 years</h4>
               <p className="text-center text-base">
                  Of experience in agricultural systems development
               </p>
            </div>
            <div className="flex w-5/12 flex-col items-center gap-5">
